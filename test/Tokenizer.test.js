...
describe('wordAndDot [Example 1]', () => {
  describe('return value', () => {
    ...
    it('[TC7]: \'\' [] should return END(\'null\')', () => {
      ...
      expect(textTokenizer.activeToken).to.eql({ type: 'END', value: null })
    })
    ...
    it('[TC11]: \'!\' [] should return Exception(\'No lexical element matches \'!\'\')', () => {
      const textTokenizer = new Tokenizer(grammar.wordAndDot, '!')
      expect(textTokenizer.activeToken).to.eql({ type: 'Exception', value: 'No lexical element matches \'!\'' })
    })
  })
})
...
describe('arithmetic [Example 2]', () => {
  describe('return value', () => {
    it('[TC12]: \'3\' [] should return NUMBER(\'3\')', () => {
      ...
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'NUMBER', value: '3' })
    })

    it('[TC13]: \'3.14\' [] should return NUMBER(\'3.14\')', () => {
      const arithmeticTokenizer = new Tokenizer(grammar.arithmetic, '3.14')

      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'NUMBER', value: '3.14' })
    })
    ...
    it('[TC14]: \'3 + 54 * 4\' [>>>] should return MUL(\'*\')', () => {
      ...
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'MUL', value: '*' })
    })
    ...
    it('[TC15]: \'3+5 # 4\' [>>>] should return Exception(\'No lexical element matches \'# 4\'\')', () => {
      ...
      arithmeticTokenizer.moveNext(3)
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'Exception', value: 'No lexical element matches \'# 4\'' })
    })
    ...
    it('[TC16]: \'3.0+54.1     + 4.2\' [><>>>] should return ADD(\'+\')', () => {
      ...
      arithmeticTokenizer.moveNext(3)
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'ADD', value: '+' })
    })

    it('[TC17]: \'(15+3) * 10\' [] should return OPENPAR(\'(\')', () => {
      const arithmeticTokenizer = new Tokenizer(grammar.arithmetic, '(15+3) * 10')

      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'OPENPAR', value: '(' })
    })
    ...
    it('[TC18]: \'(5 + 3+1) / 13 + 10\' [>>>>>>] should return CLOSEPAR(\')\')', () => {
      ...
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'CLOSEPAR', value: ')' })
    })
    ...
    it('[TC19]: \'(1 + 4) / (13 * 10)\' [>>>>>><] should return DIV(\'/\')', () => {
      ...
      arithmeticTokenizer.moveNext(6)
      arithmeticTokenizer.moveBack()
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'DIV', value: '/' })
    })
    ...
    it('[TC20]: \'3- 14\' [>] should return SUB(\'-\')', () => {
      ...
      arithmeticTokenizer.moveNext()
      expect(arithmeticTokenizer.activeToken).to.eql({ type: 'SUB', value: '-' })
    })
...
describe('maximalMunchTester [Example 3]', () => {
  describe('return value', () => {
    it('[TC23]: \'3.14\' [] should return FLOAT(\'3.14\')', () => {
      ...
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'FLOAT', value: '3.14' })
    })
    ...
    it('[TC24]: \'13.9    14\' [>] should return INTEGER(\'14\')', () => {
      ...
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'INTEGER', value: '14' })
    })
    ...
    it('[TC25]: \'0.1 0.2 13 0.1000\' [>>>] should return FLOAT(\'0.1000\')', () => {
      ...
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'FLOAT', value: '0.1000' })
    })
    ...
    it('[TC26]: \'10 9,2\' [>>] should return Exception(\'No lexical element matches \',2\'\')', () => {
      ...
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'Exception', value: 'No lexical element matches \',2\'' })
    })
    ...
    it('[TC27]: \'192.168.1.1\' [] should return FLOAT(\'192.168\')', () => {
      ...
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'FLOAT', value: '192.168' })
    })
    ...
    it('[TC28]: \'192.168.1.1\' [>] should return Exception(\'No lexical element matches \'.1.1\'\')', () => {
      ...
      maximalMunchTokenizer.moveNext()
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'Exception', value: 'No lexical element matches \'.1.1\'' })
    })
    ...
    it('[TC29]: \'0 .1\' [>] should return Exception(\'No lexical element matches \'.1\'\')', () => {
      ...
      maximalMunchTokenizer.moveNext()
      expect(maximalMunchTokenizer.activeToken).to.eql({ type: 'Exception', value: 'No lexical element matches \'.1\'' })
    })
  })
})
...
describe('moveBack() and moveNext()', () => {
  describe('return value', () => {
    it('[TC30]\'Hello everyone.\' [>>] should return DOT(\'.\')', () => {
      ...
      expect(wordAndDotTokenizer.activeToken).to.eql({ type: 'DOT', value: '.' })
    })
    ...
    it('[TC31]\'Hello everyone.\' [>>>] should return END(\'null\')', () => {
      ...
      expect(wordAndDotTokenizer.activeToken).to.eql({ type: 'END', value: null })
    })
    ...
    it('[TC34]\'Goodbye everybody.\' [<] should return WORD(\'Goodbye\')', () => {
      ...
      expect(wordAndDotTokenizer.activeToken).to.eql({ type: 'WORD', value: 'Goodbye' })
    })
    ...
    it('[TC37]\'Hello again everybody.\' [<<<<>] should return WORD(\'again\')', () => {
      ...
      expect(wordAndDotTokenizer.activeToken).to.eql({ type: 'WORD', value: 'again' })
    })
  })
})
